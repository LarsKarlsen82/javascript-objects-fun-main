...
// Filtrer ansatte over 30 år
let ansatteOver30 = myEmployees.filter(function(ansat) {
  return ansat.alder > 30;
});

// Udskriv resultatet som en tabel i konsollen
...
let ansatteUnder20 = myEmployees.filter(function(ansat) {
...
let feMaleOver30 = myEmployees.filter(function(ansat) {
  return ansat.køn == "Kvinde" && ansat.alder > 30;
});
// Udskriv resultatet som en tabel i konsollen
console.table(feMaleOver30);
...
let NonBinaryOver20 = myEmployees.filter(function(ansat) {
  return ansat.køn == "Ikke-binær" && ansat.alder > 20;
});
// Udskriv resultatet som en tabel i konsollen
console.table(NonBinaryOver20);
